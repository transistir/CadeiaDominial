    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classificacao', models.CharField(choices=[('origem_lidima', 'Origem Identificada'), ('sem_origem', 'Sem Origem'), ('inconclusa', 'Situação Inconclusa')], default='origem_lidima', max_length=50)),
