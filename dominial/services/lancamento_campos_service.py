...
class LancamentoCamposService:
    ...
    def _processar_campos_transacao(request, lancamento):
        ...
        lancamento.livro_origem = request.POST.get('livro_transacao') if request.POST.get('livro_transacao') and request.POST.get('livro_transacao').strip() else None
        lancamento.folha_origem = request.POST.get('folha_transacao') if request.POST.get('folha_transacao') and request.POST.get('folha_transacao').strip() else None
    ...
    def _processar_campos_inicio_matricula(request, lancamento):
        ...
        """
        # Processar origem
        origem_value = request.POST.get('origem_inicio', '').strip()
        lancamento.origem = origem_value if origem_value else None
        
        # Processar cartório da origem
        cartorio_origem_id = request.POST.get('cartorio_origem_inicio')
        cartorio_origem_nome = request.POST.get('cartorio_origem_nome_inicio', '').strip()
        ...
        # Processar área
        area_value = request.POST.get('area_inicio', '').strip()
